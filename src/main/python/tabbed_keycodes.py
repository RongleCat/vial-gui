...
class FilteredTabbedKeycodes(QTabWidget):
    ...
    def __init__(self, parent=None, keycode_filter=keycode_filter_any):
        ...
        self.tabs = [
            ...
            SimpleTab(self, "层", KEYCODES_LAYERS),
            SimpleTab(self, "组合键", KEYCODES_QUANTUM),
            SimpleTab(self, "背光", KEYCODES_BACKLIGHT),
            SimpleTab(self, "应用、媒体、鼠标", KEYCODES_MEDIA),
            SimpleTab(self, "MIDI", KEYCODES_MIDI),
            SimpleTab(self, "按键操作", KEYCODES_TAP_DANCE),
            SimpleTab(self, "用户", KEYCODES_USER),

...
class MacroTab(QVBoxLayout):
    ...
    def __init__(self, parent, enable_recorder):
        ...
        menu_record = QMenu()
        menu_record.addAction(tr("MacroRecorder", "添加到当前"))\
            .triggered.connect(lambda: self.record.emit(self, True))
        menu_record.addAction(tr("MacroRecorder", "替换所有"))\
        ...
        self.btn_add.setText(tr("MacroRecorder", "添加动作"))
        self.btn_add.setToolButtonStyle(Qt.ToolButtonTextOnly)
        self.btn_add.clicked.connect(self.on_add)

        self.btn_tap_enter = QToolButton()
        self.btn_tap_enter.setText(tr("MacroRecorder", "添加单击回车"))
        ...
        self.btn_text_window.setText(tr("MacroRecorder", "打开命令编辑器..."))
